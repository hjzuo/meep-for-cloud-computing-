...
geometry = [mp.Block(mp.Vector3(1e20, 1, 1),
...
eps_h5file = h5py.File('straight_waveguide_3d-eps-000000.00.h5','r')
...
ez_h5file = h5py.File('straight_waveguide_3d-ez-000200.00.h5','r')
